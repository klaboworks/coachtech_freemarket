...
class ItemsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $values = collect([
            ...
            [4, 1, 'images/items/Leather+Shoes+Product+Photo.jpg', '革靴', 4000, 'クラシックなデザインの革靴', false],
            [1, 1, 'images/items/Living+Room+Laptop.jpg', 'ノートPC', 45000, '高性能なノートパソコン', false],
            [2, 1, 'images/items/Music+Mic+4632231.jpg', 'マイク', 8000, '高音質のレコーディング用マイク', false],
            [3, 1, 'images/items/Purse+fashion+pocket.jpg', 'ショルダーバッグ', 3500, 'おしゃれなショルダーバッグ', false],
            [4, 1, 'images/items/Tumbler+souvenir.jpg', 'タンブラー', 500, '使いやすいタンブラー', false],
            [1, 1, 'images/items/Waitress+with+Coffee+Grinder.jpg', 'コーヒーミル', 4000, '手動のコーヒーミル', false],
