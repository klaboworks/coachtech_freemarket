...
class ItemsTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $values = collect([
            ...
            [4, 2, 'images/items/Leather+Shoes+Product+Photo.jpg', '革靴', 4000, 'クラシックなデザインの革靴', false],
            ...
            [3, 3, 'images/items/Purse+fashion+pocket.jpg', 'ショルダーバッグ', 3500, 'おしゃれなショルダーバッグ', false],
